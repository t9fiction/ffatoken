        ...
        <div className="flex flex-row justify-center gap-x-14 bottom-20 relative items-center mx-28">
          <div className="w-2/5 justify-center relative mx-12">
            <img
              alt=""
              src="maskgroup.png"
              className="w-[320px] h-[360px] relative top-32 border-4 border-white right-0 left-24"
            />
            <img
              alt=""
              src="image8.png"
              className="w-[320px] border-4 border-white h-[360px] relative right-28 left-0 bottom-16"
            />
          </div>
          <div className="flex flex-col w-3/5 space-y-4 mt-20">
