...
const Hero = () => {
  return (
    ...
    />
      ...
      <div className="relative left-0 right-0 bottom-[24px] top-72 w-[50%] mx-auto justify-center items-center">
        <h1 className="text-center text-white text-[76px] uppercase mx-auto">
          Agritokenization
        </h1>
        <h1 className="text-center text-white text-[76px] leading-tight uppercase ">
